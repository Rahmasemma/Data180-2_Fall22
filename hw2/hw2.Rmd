...
```{r}
pie(table(Cars93$Type),main = "Type",col=c(1:9), cex=1.2)
```
...
```{r}
hist(Cars93$Horsepower,cex.lab=1.2, cex.lab=1.2,cex.axis=1.2,col="blue",xlab = "Horsepower")
```
...
```{r}
hist(Cars93$Horsepower, cex.lab=1.2, cex.axis=1.2, col="blue" ,xlab="Horsepower", breaks=seq(0,300,25))
```
